    ...
    <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden': !isOpen, 'block': isOpen }">
      <div class="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
        ...
        <form action="/properties">
          <input type="search" class="block w-full form-input form-input-light pl-10 pr-4 py-2" placeholder="Search by keywords" name="search" :value="searchText" id="header-search">
        </form>
      </div>
