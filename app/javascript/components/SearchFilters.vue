    ...
    <div class="flex justify-between px-4 py-3 xl:hidden">
      <div class="relative max-w-xs w-full">
        ...
        <form action="/properties">
          <input type="search" class="block w-full form-input form-input-dark pl-10 pr-4 py-2" placeholder="Search by keywords" name="search" :value="searchText" id="filter-search">
        </form>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      amenities: ['Balcony', 'Pool', 'Beach', 'Pet friendly', 'Kid friendly', 'Parking', 'Air conditioning']
    }
  },
  methods: {
    toggle() {
